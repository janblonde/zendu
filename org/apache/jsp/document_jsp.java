 ...
 * Generated at: 2015-10-18 13:06:38 UTC
...
return;
  ...
  if ((session.getAttribute("userid") == null) || (session.getAttribute("userid") == "")) {
    ...
    if (rs.next()){
        ...
        while (rs2.next()){
            if (Integer.toString(rs2.getInt("id")).equals(request.getParameter("docid"))){
                //session.setAttribute("j_username","tomcat");
                //session.setAttribute("j_password", "tomcat");
                //response.sendRedirect("/zendu/brieven/" + rs2.getInt("id") + ".pdf?j_username=tomcat&j_password=tomcat");
                String pdfFileName="/brieven/86.pdf";
                String pdfFile=getServletContext().getRealPath("/brieven/86.pdf");
                out.println(pdfFile.length());
                ...
                //while( ( charsRead = fileInputStream.read( buf, 0, buf.length ) ) != -1 ) {
                //    servletOutputStream.write( buf, 0, charsRead );
                //}
